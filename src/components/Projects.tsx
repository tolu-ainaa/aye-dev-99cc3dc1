    ...
    >
      ...
      >
        ...
        <img
          ...
          className={`absolute inset-0 h-full w-full object-contain transition-opacity duration-500 ${showAfter ? "opacity-0" : "opacity-100"}`}
        />
        {/* After Image */}
        <img
          src={project.after}
          alt={`${project.title} after redesign`}
          className={`absolute inset-0 h-full w-full object-contain transition-opacity duration-500 ${showAfter ? "opacity-100" : "opacity-0"}`}
        />
        {/* Labels */}
